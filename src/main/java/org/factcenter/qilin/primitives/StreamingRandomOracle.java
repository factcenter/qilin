...
public interface StreamingRandomOracle {
	...
	/**
	 * Return a {@link Random} object that can be used to generate a
	 * stream of pseudorandom bytes from a given input.
	 * The stream is generated by concatenating a 64-bit index to the input
	 * and then hashing (starting with 0, in LSB-first order);
	 * the random stream returns the hash bits until they run out, then updates the index and rehashes.
	 *
	 * @return
	 */
